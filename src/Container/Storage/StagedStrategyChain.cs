...
namespace Unity.Container.Storage
{
    ...
    public class StagedStrategyChain<TStrategyType, TStageEnum> : IStagedStrategyChain<TStrategyType, TStageEnum>, IDisposable
    {
        ...
        private static readonly int Size = typeof(TStageEnum).GetTypeInfo().DeclaredFields.Count(f => f.IsPublic && f.IsStatic);
        private readonly object _lockObject = new object();
        private readonly StagedStrategyChain<TStrategyType, TStageEnum> _innerChain;
        private readonly IList<TStrategyType>[] _stages =  new IList<TStrategyType>[Size];
